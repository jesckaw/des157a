    ...
    function checkWinningCondition(){
        if(gameData.score[gameData.index]>gameData.gameEnd){
            ...
            if(gameData.index == 0) {
                ...
                messageOne.innerHTML =`<h2>${gameData.players[0]} wins with ${gameData.score[0]} points & became a <span style="color: #E18F31;">chicken</span>!</h2> <img src="images/${gameData.chicken[0]}">`;
                messageTwo.innerHTML = `<h2>${gameData.players[1]} loses with ${gameData.score[1]} points & became a <span style="color: #E18F31;">fried egg</span>!</h2> <img src="images/${gameData.egg}">`;
            } else {
                ...
                //new message blocks
                messageOne.innerHTML = `<h2>${gameData.players[1]} wins with ${gameData.score[1]} points & became a <span style="color: #E18F31;">chicken</span>!</h2><img src="images/${gameData.chicken[1]}">`;
                messageTwo.innerHTML = `<h2>${gameData.players[0]} loses with ${gameData.score[0]} points & became a <span style="color: #E18F31;">fried egg</span>!</h2><img src="images/${gameData.egg}">`;
