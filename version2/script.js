(function(){
    'use strict';
    alert("Hello! Thank you for participating in my user test. Your tasks are: choose a player, roll/pass the dice, and win the game for your chosen player! or not your choice.")
